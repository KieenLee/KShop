            ...
            <div class="row px-xl-5 pt-5">
                <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                    <a href="" class="text-decoration-none">
                        <h1 class="mb-4 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border border-white px-3 mr-1">K</span>Shop</h1>
                    </a>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-6">
                            ...
                            <div class="d-flex flex-column justify-content-start">
                                ...
                                <a class="text-dark mb-2" href="shop.jsp"><i class="fa fa-angle-right mr-2"></i>Shop</a>
            ...
            <div class="row border-top border-light mx-xl-5 py-4">
                <div class="col-md-6 px-xl-0">
                    <p class="mb-md-0 text-center text-md-left text-dark">
                        &copy; <a class="text-dark font-weight-semi-bold" href="#">Copyright</a>. Designed
                        in
                        <a class="text-dark font-weight-semi-bold" href="#">2025</a>
                    </p>
                </div>
            </div>
        </div>
